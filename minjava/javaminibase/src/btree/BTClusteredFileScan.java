             ...
             implements  GlobalConst
{
  ...
  int maxKeysize;
    ...
    public BTClusteredFileScan(short tupleFldCnt, AttrType[] tupleAttrType, short[] tupleStrSizes) {
    ...
    try {
	 ...
	 if (nextpage.pid == INVALID_PAGE) {
	    ...
	    return null;
         ...
         leafPage=new BTClusteredLeafPage(nextpage, keyType, tupleFldCnt, tupleAttrType, tupleStrSizes);
