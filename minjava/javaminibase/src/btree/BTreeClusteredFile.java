...
//	}
    ...
    private KeyDataEntry _insert(KeyClass key, Tuple data,
        ...
        if (currentPage.getType() == NodeType.INDEX) {
            ...
            BTClusteredLeafPage newLeafPage;
...
//            System.out.println(loopRid);
    ...
    BTClusteredLeafPage findRunStart(KeyClass lo_key,
                                     RID startrid)
            throws IOException,
            IteratorException,
            KeyNotMatchException,
...
//
//
            _Delete(key, data, headerPage.get_rootId(), null);
    ...
    private KeyClass _Delete(KeyClass key,
        ...
        if (sortPage.getType() == NodeType.LEAF_CLUSTERED) {
            RID curRid = new RID();  // iterator
            KeyDataEntry tmpEntry;
            KeyClass curkey;
            RID dummyRid;
            ...
            while ((tmpEntry != null) && (BT.keyCompare(key, tmpEntry.key) >= 0)) {
                ...
                if (leafPage.delEntry(new KeyDataEntry(key, data)) != null) {
                    ...
                    if ((4 + leafPage.available_space()) <=
                        ...
                        BTClusteredLeafPage siblingPage;
                        int direction;
                        ...
                        if (siblingPage.redistribute(leafPage, parentPage,
                            ...
                            BTClusteredLeafPage leftChild, rightChild;
                            if (direction == -1) {
        ...
        if (sortPage.getType() == NodeType.INDEX) {
            ...
            KeyClass oldChildKey = _Delete(key, data, childPageId, currentPageId);
     ...
     */
    public BTClusteredFileScan new_scan(KeyClass lo_key, KeyClass hi_key)
            throws IOException,
            KeyNotMatchException,
            IteratorException,
            ConstructPageException,
